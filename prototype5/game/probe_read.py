r"""Read a `probe_map.py` tape back and score it. No model, no GPU -- just the numbers.
...
Usage: `..\.venv\Scripts\python.exe game\probe_read.py runs/probe-<stamp>/probe.jsonl`
"""
