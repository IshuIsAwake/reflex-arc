...
class Result:
    ...
    def advice(self):
        ...
        And the third: a drive that spent the day and bought no map. `DONE(at=(10,0),
        steps=19, new=0)` is a success code with the bad news buried in a number.
        Watched twice in one sol -- retreats of 19 and 24 steps after a BLOCKED, both
        revealing nothing, 24% of the day between them -- with nothing in either answer
        saying so.
        """
        if self.beside:
