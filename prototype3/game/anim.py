...
class Reel:
    ...
    def _clear(self):
        ...
        self.hidden = set()   # revealed by nav already, held shut until we get there
    ...
    def _load(self, timeline):
        ...
        # Everything this drive revealed starts hidden and is handed back a step at a
        # time. Without it the fog is already gone before the rover sets off.
