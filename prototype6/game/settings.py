...
DAY_MODE = "gemma"
DAY_SECONDS = 300
DAY_STEPS = 120         # one per tile driven; reduced to test objective prioritization

TIME_SCALE = 1.0        # 2.0 makes the day run twice as fast
VISION_RADIUS = 3       # how far the rover sees as it drives
BASE_REVEAL = 100         # and what it sees on arrival, so day one opens on ground
...
CHAT_W = 720            # pixel width of the pane
