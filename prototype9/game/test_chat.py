...
# kind would be inventing it. `read_notes`/`write_notes` came off it when the write path
# landed as `todo`/`strike`/`remember`; `mark(` stays, which is why `avoid="auto"` is
# still refused.
UNBUILT = ("look(", "interact(", "play(", "buy(", "mark(",
